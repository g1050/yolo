...
if __name__ == '__main__':
    # 调试用，依次取出数据看看是否正确
    dataset_dir = "/data/xkgao/YOLO-World/dataset/voc2012/anyforge/pascal-voc-2012/VOC2012_train_val/voc2012_forYolov1"
    dataset = MyDataset(dataset_dir)
    dataloader = DataLoader(dataset, 1)
    for i in enumerate(dataloader):
        print(f"Image shape: {i[1][0].shape}")
        print(f"Label shape: {i[1][1].shape}")
